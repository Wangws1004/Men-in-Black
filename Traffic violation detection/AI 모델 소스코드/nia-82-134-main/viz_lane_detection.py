...
parser.add_argument("--config", default="./configs/lane_detection_config.py")
...
parser.add_argument("--save_dir", default="./viz_output/lane_detection")
...
def main():
    logger.info("Start lane detection inference")
